...
<template>
  ...
  <aside id="logo-sidebar" class="z-[9999]" aria-label="Sidebar">
...
#logo-sidebar {
  @apply fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0;

  .sidebar-item {
    @apply flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700;

    .icon {
      @apply shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400;
    }
...
.main-body-container {
  @apply p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700;
}
</style>
