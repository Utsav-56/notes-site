...
<template>
  ...
  <div class="subject-card w-[99%] bg-base-100 shadow-md hover:shadow-2xl scale-[0.94] hover:scale-[1] transition-transform tdelay-500 duration-550 ease-in-out "  v-for="subject in semStore.semesterData[currentSemester]" :key="subject.name">
    <figure>
    ...
    <div class="card-body">
      ...
      <div class="materials p-1">
        <button class="material-btn btn btn-small hover:shadow-sm  text-white "  v-for="materials in subject.materials " :key="subject.materials">{{materials}}</button>
