...
const handleSubmit = async () => {
    try {
        ...
        const response = await customAxios.post("/auth/signup.php", {
            name,
            email,
            password,
            role,
...
<template>
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
        <div
            class="bg-white shadow-lg rounded-lg p-10 w-full max-w-md text-center"
        >
            <div class="mb-6">
            ...
            <form @submit.prevent="handleSubmit" class="space-y-4">
                ...
                <div class="text-left">
                    <label for="role" class="block text-sm text-gray-700">
                        Role
                    </label>
                    <select
            ...
            <div class="mt-4 text-sm text-gray-600">
                ...
                <router-link
                    to="/"
                    class="text-green-600 hover:underline block mt-2"
                >
                    Go to home
                </router-link>
            </div>
